...
const CSV_S3_PATH = 'static/MimiFUND.csv'
const CSV_FILE_PATH = '../__FILES__/static/MimiFUND.csv'

export class MimiFUNDPipeline extends Construct {
    public table: dynamodb.Table;
    public tableMap: Record<string, string>
