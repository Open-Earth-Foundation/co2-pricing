...
import BigDescriptionBlock from "./BigDescriptionBlock";
      ...
      >
        ...
        >
          <Flex
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "visibility4728412")}
          >
            <View
              width="36px"
              height="36px"
              ...
              {...getOverrideProps(overrides, "Bounding box4728413")}
            ></View>
            <Icon
              width="33px"
              height="22.5px"
              ...
              left="4.17%"
              right="4.17%"
              {...getOverrideProps(overrides, "visibility4728414")}
            ></Icon>
          </Flex>
          <Text
            fontFamily="Inter"
        ...
        >
          <Flex
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "help4728417")}
          >
            <View
              width="32px"
              height="32px"
              ...
              padding="0px 0px 0px 0px"
              backgroundColor="rgba(217,217,217,1)"
              {...getOverrideProps(overrides, "Bounding box4728418")}
            ></View>
            <Icon
              width="26.67px"
              height="26.67px"
              ...
              left="8.33%"
              right="8.33%"
              {...getOverrideProps(overrides, "help4728419")}
            ></Icon>
          </Flex>
          <Text
            fontFamily="Inter"
          ...
          >
            ...
            <Flex
              ...
              shrink="0"
              position="relative"
              {...getOverrideProps(overrides, "arrow_forward4728423")}
            >
              <View
                width="24px"
                height="24px"
                ...
                padding="0px 0px 0px 0px"
                backgroundColor="rgba(217,217,217,1)"
                {...getOverrideProps(overrides, "Bounding box4728424")}
              ></View>
              <Icon
                width="16px"
                height="16px"
                ...
                left="16.67%"
                right="16.67%"
                {...getOverrideProps(overrides, "arrow_forward4728425")}
              ></Icon>
            </Flex>
          </Flex>
        </Flex>
        ...
        >
          ...
          >
            <Flex
              ...
              {...getOverrideProps(overrides, "Slider5428218")}
            >
              <Flex
                gap="12px"
                direction="column"
              ...
              >
                <Flex
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Discount Rate5428220")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="20px"
                    ...
                    {...getOverrideProps(overrides, "Discount Rate5428221")}
                  ></Text>
                  <View
                    width="unset"
                    height="24px"
                    ...
                    borderRadius="8px"
                    padding="0px 0px 0px 0px"
                    {...getOverrideProps(overrides, "Slider5428222")}
                  >
                    <View
                      width="364px"
                      height="8px"
                    ...
                    <View
                      ...
                      right="409px"
                      padding="0px 0px 0px 0px"
                      {...getOverrideProps(overrides, "Right control5428226")}
                    ></View>
                    <Icon
                      width="18px"
                      height="18px"
                      ...
                      top="3px"
                      left="93px"
                      {...getOverrideProps(overrides, "Right control5428227")}
                    ></Icon>
                  </View>
                  <Text
                    fontFamily="Inter"
            ...
            >
              ...
              >
                ...
                <Icon
                  ...
                  left="8.33%"
                  right="8.34%"
                  {...getOverrideProps(overrides, "help4728448")}
                ></Icon>
              </Flex>
              <Text
                fontFamily="Inter"
