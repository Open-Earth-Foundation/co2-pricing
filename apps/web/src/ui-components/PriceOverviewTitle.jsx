...
export default function PriceOverviewTitle(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "PriceOverviewTitle")}
      {...rest}
    >
      <Flex
        gap="6px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 6921")}
      >
        <Flex
          padding="0px 0px 0px 0px"
          width="36px"
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "visibility12729")}
        >
          <View
            width="36px"
            height="36px"
            ...
            {...getOverrideProps(overrides, "Bounding box12730")}
          ></View>
          <Icon
            width="33px"
            height="22.5px"
            ...
            left="4.17%"
            right="4.17%"
            {...getOverrideProps(overrides, "visibility12731")}
          ></Icon>
        </Flex>
        <Text
          fontFamily="Inter"
      ...
      <CalculatorHeader
        ...
        {...getOverrideProps(overrides, "CalculatorHeader")}
      ></CalculatorHeader>
      <Flex
        gap="53px"
        direction="row"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 6922")}
      >
        <Flex
          gap="53px"
          direction="column"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 6924")}
        >
          <Flex
            gap="13px"
            direction="column"
            ...
            borderRadius="12px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 6912")}
          >
            <Text
              fontFamily="Inter"
              fontSize="20px"
            ...
            >
              <Text
                ...
                whiteSpace="pre-wrap"
                children="$10000"
                {...getOverrideProps(overrides, "$10000")}
              ></Text>
            </Flex>
            <Text
              fontFamily="Inter"
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="in USD per Ton of CO2 (2023)"
              {...getOverrideProps(overrides, "in USD per Ton of CO2 (2023)")}
            ></Text>
          </Flex>
          <Flex
            gap="6px"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 6949")}
          >
            <Flex
              gap="24px"
              direction="column"
              ...
              {...getOverrideProps(overrides, "Frame 2612751")}
            >
              <Flex
                gap="12px"
                direction="column"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 2512752")}
              >
                <Flex
                  gap="8px"
                  direction="column"
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Discount Rate12753")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="20px"
                    ...
                    {...getOverrideProps(overrides, "Discount Rate12754")}
                  ></Text>
                  <View
                    width="unset"
                    height="24px"
                  ...
                  >
                    ...
                    <View
                      ...
                      right="409px"
                      padding="0px 0px 0px 0px"
                      {...getOverrideProps(overrides, "Right control12759")}
                    ></View>
                    <Icon
                      width="18px"
                      height="18px"
                      ...
                      top="3px"
                      left="173px"
                      {...getOverrideProps(overrides, "Right control12760")}
                    ></Icon>
                  </View>
                  <Text
                    fontFamily="Inter"
                    ...
                    whiteSpace="pre-wrap"
                    children="1.5%"
                    {...getOverrideProps(overrides, "1.5%")}
                  ></Text>
                </Flex>
              </Flex>
            </Flex>
            ...
            >
              <Flex
                ...
                shrink="0"
                position="relative"
                {...getOverrideProps(overrides, "help12763")}
              >
                <View
                  width="24px"
                  height="24px"
                  ...
                  padding="0px 0px 0px 0px"
                  backgroundColor="rgba(217,217,217,1)"
                  {...getOverrideProps(overrides, "Bounding box12764")}
                ></View>
                <Icon
                  width="20px"
                  height="20px"
                  ...
                  left="8.33%"
                  right="8.34%"
                  {...getOverrideProps(overrides, "help12765")}
                ></Icon>
              </Flex>
              <Text
                fontFamily="Inter"
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="A higher discount rate implies that future generations are valued less than today's generation. A lower discount rate implies a greater value for future generations. It is recommended to keep discount rates to less than 2% to meet this balance."
                {...getOverrideProps(
                  overrides,
        ...
        >
          ...
          >
            <Flex
              ...
              {...getOverrideProps(overrides, "Frame 2671421")}
            >
              <Flex
                gap="12px"
                direction="column"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 2571422")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="20px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Benchmarks"
                  {...getOverrideProps(overrides, "Benchmarks")}
                ></Text>
              </Flex>
              <Flex
                padding="0px 0px 0px 0px"
                ...
                shrink="0"
                position="relative"
                {...getOverrideProps(overrides, "expand_more71437")}
              >
                <View
                  width="24px"
                  height="24px"
                  ...
                  padding="0px 0px 0px 0px"
                  backgroundColor="rgba(217,217,217,1)"
                  {...getOverrideProps(overrides, "Bounding box71432")}
                ></View>
                <Icon
                  width="12px"
                  height="7.4px"
                  ...
                  left="25%"
                  right="25%"
                  {...getOverrideProps(overrides, "expand_more71436")}
                ></Icon>
              </Flex>
            </Flex>
          </Flex>
          <Flex {...getOverrideProps(overrides, "Chart")}></Flex>
        </Flex>
      </Flex>
    </Flex>
  );
