...
export declare type IntegrationModalProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: IntegrationModalOverridesProps | undefined | null;
}>;
export default function IntegrationModal(props: IntegrationModalProps): React.ReactElement;
