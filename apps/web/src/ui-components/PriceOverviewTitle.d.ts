...
export declare type PriceOverviewTitleProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: PriceOverviewTitleOverridesProps | undefined | null;
}>;
export default function PriceOverviewTitle(props: PriceOverviewTitleProps): React.ReactElement;
