...
export default function MethodDescription(props) {
  const { title, body, overrides, ...rest } = props;
  return (
    <Flex
      gap="40px"
      direction="row"
      ...
      {...getOverrideProps(overrides, "MethodDescription")}
      {...rest}
    >
      <Flex
        gap="36px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 6909")}
      >
        <Flex
          gap="11px"
          direction="column"
        ...
        >
          ...
          >
            <Flex
              ...
              shrink="0"
              position="relative"
              {...getOverrideProps(overrides, "help12819")}
            >
              <View
                width="30px"
                height="30px"
                ...
                {...getOverrideProps(overrides, "Bounding box12820")}
              ></View>
              <Icon
                width="25px"
                height="25px"
                ...
                left="8.33%"
                right="8.33%"
                {...getOverrideProps(overrides, "help12821")}
              ></Icon>
            </Flex>
            <Text
              fontFamily="Inter"
              ...
              whiteSpace="pre-wrap"
              children={title}
              {...getOverrideProps(overrides, "Method description")}
            ></Text>
          </Flex>
          <Flex
            gap="11px"
          ...
          >
            ...
            >
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "14 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Risus vel nibh nunc, est sollicitudin pellentesque tincidunt ultrices. Magna elit enim fames fames sem at blandit. Pellentesque varius volutpat lobortis consequat ornare ut aliquam ornare rhoncus. Molestie cursus sed sed imperdiet varius."
                )}
              ></Text>
            </Flex>
            <Flex
            ...
            >
              ...
              <Flex
                ...
                shrink="0"
                position="relative"
                {...getOverrideProps(overrides, "arrow_forward12828")}
              >
                <View
                  width="24px"
                  height="24px"
                  ...
                  padding="0px 0px 0px 0px"
                  backgroundColor="rgba(217,217,217,1)"
                  {...getOverrideProps(overrides, "Bounding box12829")}
                ></View>
                <Icon
                  width="16px"
                  height="16px"
                  ...
                  left="16.67%"
                  right="16.67%"
                  {...getOverrideProps(overrides, "arrow_forward12830")}
                ></Icon>
              </Flex>
            </Flex>
          </Flex>
