...
export default function Frame6914(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "Frame6914")}
      {...rest}
    >
      <BigDescriptionBlock
        display="flex"
        ...
        {...getOverrideProps(overrides, "Big Description Block")}
      ></BigDescriptionBlock>
      <Flex
        gap="40px"
        direction="column"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 6919")}
      >
        <Flex
          gap="6px"
          direction="row"
        ...
        <Flex
          ...
          {...getOverrideProps(overrides, "Frame 68654728416")}
        >
          <Flex
            padding="0px 0px 0px 0px"
            width="32px"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                {...getOverrideProps(overrides, "Frame 68654728445")}
              >
                <Flex
                  padding="0px 0px 0px 0px"
                  width="24px"
      ...
      <View
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 69344728514")}
      >
        <Frame6934
          display="flex"
          gap="11px"
          ...
          property1="Default"
          {...getOverrideProps(overrides, "Frame 69344728515")}
        ></Frame6934>
      </View>
      <Flex
        gap="24px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 6915")}
      >
        <DescriptionBlock
          display="flex"
          gap="11px"
