...
export default function DiscountRateInfo(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "DiscountRateInfo")}
      {...rest}
    >
      <Flex
        ...
        shrink="0"
        position="relative"
        {...getOverrideProps(overrides, "help71587")}
      >
        <View
          width="24px"
          height="24px"
        ...
        <Icon
          width="20px"
          height="20px"
          viewBox={{ minX: 0, minY: 0, width: 20, height: 19.99999237060547 }}
          paths={[
            {
          ...
          left="8.33%"
          right="8.34%"
          {...getOverrideProps(overrides, "help71589")}
        ></Icon>
      </Flex>
      <Text
        fontFamily="Inter"
