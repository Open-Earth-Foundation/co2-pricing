...
export declare type MethodDescriptionProps = React.PropsWithChildren<Partial<FlexProps> & {
    title?: String;
    body?: String;
} & {
    overrides?: MethodDescriptionOverridesProps | undefined | null;
}>;
export default function MethodDescription(props: MethodDescriptionProps): React.ReactElement;
