  ...
  return (
    <div>
      ...
      >
        ...
        >
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Model description (MIMI FUND)"
              {...getOverrideProps(overrides, "Model description (MIMI FUND)")}
            ></Text>
          </Flex>
        </Flex>
        <Flex
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`The Climate Framework for Uncertainty, Negotiation and Distribution (FUND) is a so-called integrated assessment model (IAM) of climate change. \nFUND links scenarios and simple models of population, technology, economics, emissions, atmospheric chemistry, climate, sea level, and impacts. \nIt is used to perform cost-benefit and cost-effectiveness analyses of GHG emission reduction policies, to study equity of climate change and climate policy, and to support game-theoretic investigations into international environmental agreements.`}
            {...getOverrideProps(
              overrides,
      ...
      <Flex
        ...
        {...getOverrideProps(overrides, "DescriptionBlockCTA")}
        {...rest}
      >
        <Flex
          gap="12px"
