...
# !!! Main.UserApp is configured as an alias for Main.MimiFUNDAPI and you might encounter it in some tests
using Main.MimiFUNDAPI, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MimiFUNDAPI tests" begin
  @includetests ARGS
end
